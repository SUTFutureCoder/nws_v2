 ...
 (function(a) {
    ...
    .i18.en = {
        ...
        messages: {
            ...
            errUnknown: "未知错误.",
            errUnknownCmd: "未知命令.",
            errJqui: "jQ UI不可用. 需要引入选择、拖拽、放置脚本文件.",
            errNode: "编辑器需要DOM文件来创建它.",
            errURL: "不可用的编辑器配置，没有设置URL.",
            errAccess: "没有访问权限.",
            errConnect: "无法连接后台.",
            errAbort: "放弃连接.",
            errTimeout: "连接超时.",
            ...
            errResponse: "后台无响应.",
            errConf: "不可用的后台配置.",
            errJSON: "PHP JSON 模块没有安装.",
            errNoVolumes: "不可用的可读卷.",
            errCmdParams: '不可用的命令行 "$1".',
            errDataNotJSON: "数据不是 JSON 格式.",
            errDataEmpty: "数据非空.",
            errCmdReq: "后台需要请求命令名.",
            errOpen: '无法打开 "$1".',
            errNotFolder: "目标不是文件夹.",
            errNotFile: "目标不是文件.",
            errRead: '无法读取 "$1".',
            errWrite: '无法写入 "$1".',
            errPerm: "拒绝授权.",
            errLocked: '"$1" 被锁定，您无法重命名、移动或删除.',
            errExists: '文件名 "$1" 已存在.',
            errInvName: "不可用的文件名.",
            errFolderNotFound: "文件夹未找到.",
            errFileNotFound: "文件未找到.",
            errTrgFolderNotFound: '目标文件夹 "$1" 未找到.',
            errPopup: "浏览器禁止打开弹出窗口. 请在浏览器设置选项中打开.",
            errMkdir: '无法创建文件夹 "$1".',
            errMkfile: '无法创建文件 "$1".',
            errRename: '无法重命名 "$1".',
            errCopyFrom: '不允许从文件夹复制 "$1".',
            errCopyTo: '不允许复制文件至 "$1".',
            errUpload: "上传失败.",
            errUploadFile: '无法上传 "$1".',
            errUploadNoFiles: "未找到能够上传的文件.",
            errUploadTotalSize: "数据大小超过了最大限制.",
            errUploadFileSize: "文件大小超过了最大限制.",
            errUploadMime: "不支持的文件类型.",
            errUploadTransfer: '"$1" 传输错误.',
            errNotReplace: '目标 "$1" 已经存在于这个位置，您无法用其他类型的文件覆盖它.',
            errReplace: '无法替换 "$1".',
            errSave: '无法保存 "$1".',
            errCopy: '无法复制 "$1".',
            errMove: '无法移动 "$1".',
            errCopyInItself: '不能复制 "$1" 于它自身.',
            errRm: '无法删除文件 "$1".',
            errRmSrc: "无法删除源文件.",
            errExtract: '无法解压 "$1" .',
            errArchive: "无法创建文档.",
            errArcType: "不支持的文件类型.",
            errNoArchive: "文件类型不支持.",
            errCmdNoSupport: "后台不支持这个指令.",
            errReplByChild: "文件 “$1” 不能覆盖已存在的文件.",
            errArcSymlinks: "For security reason denied to unpack archives contains symlinks.",
            errArcMaxSize: "Archive files exceeds maximum allowed size.",
            errResize: '无法改变 "$1" 的大小.',
            errUsupportType: "不支持的文件类型.",
            errNotUTF8Content: '文件 "$1" 编码不是UTF-8，因此您无法编辑它.',
        ...
        return this.not(".elfinder-cwd").each(function() {
            ...
            O = function(a) {
                ...
                while (e--) {
                    ...
                    l = k.hash;
                    if (S.find("#" + l)
                    .length) continue; (m = i(k)) && m.length ? m.before(y(k)) : (n = j(k)) >= 0 ? G.splice(n, 0, k) : d.append(y(k)),
